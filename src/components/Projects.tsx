...
const projects = [
  {
    ...
    description: 'An AI-powered data analysis tool that can answer questions about your data in natural language.',
  ...
  {
    title: 'GourmetGo',
    description: 'A food delivery microservice application, similar to Uber Eats.',
    image: 'https://via.placeholder.com/400x250',
    tags: ['Java', 'Spring Boot', 'Microservices'],
    github: 'https://github.com/iLee-x/gourmetgo',
    category: 'BACKEND',
    status: 'ACTIVE',
  },
  {
    title: 'MindEvent',
    description: 'A collaborative mind-mapping and event planning tool.',
    image: 'https://via.placeholder.com/400x250',
    tags: ['Next.js', 'TypeScript', 'Firebase'],
    github: 'https://github.com/iLee-x/MindEvent',
    category: 'FULLSTACK',
    status: 'BETA',
  },
  {
    title: 'QA System',
    description: 'A question-answering system using natural language processing.',
    image: 'https://via.placeholder.com/400x250',
    tags: ['Python', 'NLP', 'Flask'],
    github: 'https://github.com/iLee-x/qa-system',
    category: 'AI',
    status: 'ACTIVE',
  },
];
